...
function generate_blocks24h_json_files($mysqli, $testnet = 0) {
    ...
    $cachefnam = CACHEFOLDER.sprintf("axeninja_protocolesc_%d",$testnet);
    ...
    if ($result = $mysqli->query($sql)) {
        ...
        $data = array('status' => 'OK',
            ...
            'api' => array(
                'version' => 4,
                'compat' => 4,
                'bev' => 'bk24h='.AXENINJA_BEV.".".AXENINJA_CRONVERSION
            )
        ));
...
function generate_nodesstatus_json_files($mysqli, $testnet = 0) {
    ...
    $data = array('status' => 'OK',
        'data' => array('nodes' => $nodes,
            ...
            'api' => array('version' => 3,
                'compat' => 3,
                'bev' => 'mnst='.AXENINJA_BEV.'.'.AXENINJA_CRONVERSION)
        ));
...
function generate_blocksconsensus_json_files($mysqli, $testnet = 0) {
    ...
    $data = array('status' => 'OK',
        'data' => array('blocksconsensus' => $bhinfofinal,
            ...
            'api' => array('version' => 3,
                'compat' => 3,
                'bev' => 'bkcs='.AXENINJA_BEV.'.'.AXENINJA_CRONVERSION)
        ));
...
function generate_governancevotelimit_json_files($mysqli, $testnet = 0) {
    ...
    $data = array('status' => 'OK',
        ...
        'api' => array(
            'version' => 1,
            'compat' => 1,
            'bev' => 'gpvl=' . AXENINJA_BEV . "." . AXENINJA_CRONVERSION
        )
    ));
...
function generate_governanceproposals_json_files($mysqli, $testnet = 0) {
    ...
    echo "OK (".$currentblock["BlockId"]." / Estimated budget amount: ".$estimatedbudgetamount." AXE)\n";
    ...
    $data = array('status' => 'OK',
        ...
        'api' => array(
            'version' => 2,
            'compat' => 1,
            'bev' => 'gp='.AXENINJA_BEV.".".AXENINJA_CRONVERSION
        )
        ));
...
function generate_governancetriggers_json_files($mysqli, $testnet = 0) {
    ...
    $data = array('status' => 'OK',
        ...
        'api' => array(
            'version' => 1,
            'compat' => 1,
            'bev' => 'gt='.AXENINJA_BEV.".".AXENINJA_CRONVERSION
        )
        ));
    ...
    $data = array("status" => 'OK',
        'data' => array('superblocks' => $superblocks,
            ...
            'api' => array(
                'version' => 1,
                'compat' => 1,
                'bev' => 'sb='.AXENINJA_BEV.".".AXENINJA_CRONVERSION
            )
        ));
