...
$(document).ready(function(){
  ...
  if (axeninjatestnet == 1) {
      ...
      if (typeof axeninjatestnettor !== 'undefined') {
          $('a[name=axeninjatorurl]').attr("href", "http://"+axeninjatestnettor+"/blocks.html");
          $('span[name=axeninjatordisplay]').show();
      }

      if (typeof axeninjatestneti2p !== 'undefined') {
          $('a[name=axeninjai2purl]').attr("href", "http://" + axeninjatestneti2p + "/blocks.html");
          $('span[name=axeninjai2pdisplay]').show();
      }
  }
  else {
        if (typeof axeninjator !== 'undefined') {
            $('a[name=axeninjatorurl]').attr("href", "http://"+axeninjator+"/blocks.html");
            $('span[name=axeninjatordisplay]').show();
        }

        if (typeof axeninjai2p !== 'undefined') {
            $('a[name=axeninjai2purl]').attr("href", "http://" + axeninjai2p + "/blocks.html");
            $('span[name=axeninjai2pdisplay]').show();
        }
  }
   ...
   $('#blockstable').on('xhr.dt', function ( e, settings, json ) {
        // Show global stats
        $('#globalsupplyamount').text( addCommas( json.data.stats.global.SupplyAmount) +' '+axeninjacoin[axeninjatestnet] );
        $('#globalmnamount').text( addCommas( json.data.stats.global.MNPaymentsAmount) +' '+axeninjacoin[axeninjatestnet] );
   ...
   tableBlocks = $('#blockstable').dataTable( {
        ajax: { url: "/data/blocks24h-"+axeninjatestnet+".json",
                dataSrc: 'data.blocks',
                cache: true },
